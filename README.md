...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create yuhu-f08c
  fly apps create yuhu-f08c-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app yuhu-f08c
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app yuhu-f08c-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'yuhu-f08c-staging' does not match app name in config file 'yuhu-f08c'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name yuhu-f08c-db
  fly postgres attach --app yuhu-f08c yuhu-f08c-db

  fly postgres create --name yuhu-f08c-staging-db
  fly postgres attach --app yuhu-f08c-staging yuhu-f08c-staging-db
  ```
